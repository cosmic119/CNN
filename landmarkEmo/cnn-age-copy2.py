...
training_data = training_data.reshape(438, 68, 4)
print("hi")
print(training_data.shape)
prediction_data = np.asarray(prediction_data)
prediction_data = prediction_data.reshape(107, 68, 4)
...
test_datagen.fit(prediction_data)
...
#training_set = datagen.flow((training_data,training_labels),target_size = (256, 256),batch_size = 10,class_mode = 'categorical')

#test_set = test_datagen.flow_from_directory((prediction_data,prediction_labels,target_size = (256, 256),batch_size = 10,class_mode = 'categorical')
