...
training_data = training_data.reshape(training_data.shape[0], 4,64)
print(training_data.shape)
prediction_data = np.asarray(prediction_data)
prediction_data = prediction_data.reshape(prediction_data.shape[0],4,64)

training_data = training_data.reshape(training_data.shape[0], 4, 64,1)
prediction_data = prediction_data.reshape(prediction_data.shape[0], 4, 64,1)
